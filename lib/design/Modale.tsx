 ...
 * place dans le flux.
 *
 * **Pourquoi elle existe.** L'ajout d'un contact se dépliait sous son bouton,
 * dans la colonne de droite de l'en-tête : huit champs coincés dans un tiers
 * de la largeur, la liste repoussée en bas de page, et l'oeil qui ne savait
 * plus où regarder. Un formulaire de huit champs n'est pas une annexe de
 * l'en-tête, c'est ce qu'on fait à ce moment-là.
 *
